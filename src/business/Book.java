...
final public class Book implements Serializable {
    ...
    public BookCopy getNextAvailableCopy(HashMap<Integer, Boolean> copyNoMap) {
        Optional<BookCopy> optional = Arrays.stream(copies).filter(bookCopy -> bookCopy.isAvailable() && !copyNoMap.containsKey(bookCopy.getCopyNum())).findFirst();
